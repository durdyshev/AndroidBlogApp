...
public class Obshydostlar_adapterclass extends RecyclerView.Adapter<Obshydostlar_adapterclass.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.obshy_dostlar_yeke_haly, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ImageView arkafon;
                final TextView ady, ido, sany;
                Button glawny, yaz, blok;
                ...
                firebaseFirestore.collection("ulanyjylar").document(id).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                        ...
                        if (arka.equals("")) {
                            ...
                            Glide.with(context).load(R.drawable.background).apply(requestOptions).into(arkafon);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mView = itemView;
            card = mView.findViewById(R.id.obshy_dostlar_yeke_haly_card);
            AdyView = mView.findViewById(R.id.obshy_dostlar_yeke_haly_ady);
            imageView = mView.findViewById(R.id.obshy_dostlar_yeke_haly_profil);
            user_id = mView.findViewById(R.id.obshy_dostlar_yeke_haly_id);
        }
