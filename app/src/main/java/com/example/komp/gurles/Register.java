...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.justblog.R.layout.activity_register);
        firebaseFirestore = FirebaseFirestore.getInstance();
        Regemail = findViewById(R.id.reg_email);
        Regparol = findViewById(R.id.reg_parol);
        Regparolgaytala = findViewById(R.id.reg_parol_gaytala);
        regdoret = findViewById(R.id.reg_doret_knopka);
        reglogin = findViewById(R.id.reg_gir);
                                ...
                                .addOnCompleteListener(Register.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            String deviceToken = FirebaseMessaging.getInstance().getToken().getResult();
                                            Map<String, Object> userMap = new HashMap<>();
                                            userMap.put("token", deviceToken);
                                            userMap.put("typing", "hickim");
                                            userMap.put("kontakt", "");
                                            userMap.put("arkafon", "");
                                            userMap.put("pikir", "Hey there I am using BlogApp");
                                            userMap.put("number", "");
